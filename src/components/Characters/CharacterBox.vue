<template>
  <div class="flex flex-col w-full">
    <div
      class="title font-bold text-white lg:text-9xl md:text-8xl text-5xl m-4 text-center"
    >
    ...
    <div class="_center flex-col">
      <div class="text-lg container">
        <div class="w-full">
          <span class="capitalize font-semibold"> Gender: </span>
          <span>
        ...
        <div class="w-full">
          <span class="capitalize font-semibold"> Species: </span>
          <span>
